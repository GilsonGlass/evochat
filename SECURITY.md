Evochat is looking forward to working with security researchers worldwide to keep Evochat and our users safe. If you have found an issue in our systems/applications, please reach out to us.
...
If you have any questions about the process, contact security@evochat.com.
...
> Note: Please do not perform testing against Evochat production services. Use a `self-hosted instance` to perform tests.
...
You can learn more about our triaging process [here](https://www.evochat.com/docs/contributing-guide/security-reports).
...
If you are unsure about the scope, please create a [report](https://huntr.dev/repos/evochat/evochat/).


## Thanks

Thank you for keeping Evochat and our users safe. 🙇
