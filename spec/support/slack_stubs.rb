module SlackStubs
  ...
  def message_event
    {
      ...
      client_msg_id: 'ffc6e64e-6f0c-4a3d-b594-faa6b44e48ab',
      type: 'message',
      text: 'this is test <https://evochat.com> Hey <@U019KT237LP|Sojan> Test again',
      user: 'ULYPAKE5S',
      ts: '1588623033.006000',
      team: 'TLST3048H',
  ...
  def file_stub
    [
      {
        mimetype: 'image/png',
        url_private: 'https://evochat-assets.local/sample.png',
        name: 'name_of_the_file',
        title: 'title_of_the_file',
        filetype: 'png',
        url_private_download: 'https://evochat-assets.local/sample.png'
      }
    ]
  end
