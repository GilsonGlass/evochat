...
describe Instagram::SendOnInstagramService do
  ...
  let!(:instagram_channel) { create(:channel_instagram_fb_page, account: account, instagram_id: 'evochat-app-user-id-1') }
  ...
  describe '#perform' do
    context 'with reply' do
      ...
      context 'without message_tag HUMAN_AGENT' do
        ...
        it 'if message is sent from evochat and is outgoing' do
        ...
        it 'if message with attachment is sent from evochat and is outgoing' do
