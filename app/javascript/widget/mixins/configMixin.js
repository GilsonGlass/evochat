export default {
  computed: {
    ...
    hasAConnectedAgentBot() {
      return !!window.evochatWebChannel.hasAConnectedAgentBot;
    },
    inboxAvatarUrl() {
      return window.evochatWebChannel.avatarUrl;
    },
    channelConfig() {
      return window.evochatWebChannel;
    },
    ...
    preChatFormEnabled() {
      return window.evochatWebChannel.preChatFormEnabled;
    },
    preChatFormOptions() {
      let preChatMessage = '';
      const options = window.evochatWebChannel.preChatFormOptions || {};
