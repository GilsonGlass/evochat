...
export default {
  ...
  mounted() {
    const { websiteToken, locale, widgetColor } = window.evochatWebChannel;
  ...
  methods: {
    ...
    setLocale(localeWithVariation) {
      ...
      const { enabledLanguages } = window.evochatWebChannel;
    ...
    registerCampaignEvents() {
      ...
      bus.$on('execute-campaign', campaignDetails => {
        ...
        const { websiteToken } = window.evochatWebChannel;
...
<style lang="scss">
@import '~widget/assets/scss/evo.scss';
</style>
