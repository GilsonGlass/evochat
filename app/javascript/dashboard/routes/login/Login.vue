...
import { parseBoolean } from '@evochat/utils';
...
export default {
  ...
  methods: {
    ...
    showSignupLink() {
      return parseBoolean(window.evochatConfig.signupEnabled);
    },
    showGoogleOAuth() {
      return Boolean(window.evochatConfig.googleOAuthClientId);
    },
    login() {
