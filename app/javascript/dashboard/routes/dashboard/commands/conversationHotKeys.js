...
export default {
  ...
  computed: {
    ...
    statusActions() {
      const isOpen =
        this.currentChat?.status === evoConstants.STATUS_TYPE.OPEN;
      const isSnoozed =
        this.currentChat?.status === evoConstants.STATUS_TYPE.SNOOZED;
      const isResolved =
        this.currentChat?.status === evoConstants.STATUS_TYPE.RESOLVED;
