<template>
  <div class="columns profile--settings">
    <form v-if="!uiFlags.isFetchingItem" @submit.prevent="updateAccount">
      ...
      <div class="current-version">
        ...
        <div v-if="hasAnUpdateAvailable && globalConfig.displayManifest">
          {{
            $t('GENERAL_SETTINGS.UPDATE_EVOCHAT', {
              latestEvochatVersion: latestEvochatVersion,
            })
          }}
        </div>
        <div class="build-id">
    ...
    <evo-loading-state v-if="uiFlags.isFetchingItem" />
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    hasAnUpdateAvailable() {
      if (!semver.valid(this.latestEvochatVersion)) {
        return false;
      }
