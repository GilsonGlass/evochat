<template>
  <div v-if="isATwilioChannel" class="settings--content">
    ...
    >
      <evo-code :script="inbox.callback_webhook_url" lang="html" />
    </settings-section>
  </div>
    ...
    <div class="settings--content">
      ...
      >
        <evo-code
          ...
          lang="html"
          :codepen-title="`${inbox.name} - Evochat Widget Test`"
      ...
      >
        <evo-code :script="inbox.hmac_token" />
      </settings-section>
      <settings-section
  ...
  <div v-else-if="isAPIInbox" class="settings--content">
    ...
    >
      <evo-code :script="inbox.inbox_identifier" />
    </settings-section>
  ...
  <div v-else-if="isAnEmailChannel">
    <div class="settings--content">
      ...
      >
        <evo-code :script="inbox.forward_to_email" />
      </settings-section>
    </div>
  ...
  <div v-else-if="isAWhatsAppChannel && !isATwilioChannel">
    <div v-if="inbox.provider_config" class="settings--content">
      ...
      >
        <evo-code :script="inbox.provider_config.webhook_verify_token" />
      </settings-section>
      <settings-section
        :title="$t('INBOX_MGMT.SETTINGS_POPUP.WHATSAPP_SECTION_TITLE')"
        :sub-title="$t('INBOX_MGMT.SETTINGS_POPUP.WHATSAPP_SECTION_SUBHEADER')"
      >
        <evo-code :script="inbox.provider_config.api_key" />
      </settings-section>
      <settings-section
