<template>
  <div class="row app-wrapper">
    ...
    <section class="app-content columns">
      ...
      />
      <evo-modal :show.sync="showAddLabelModal" :on-close="hideAddLabelPopup">
...
import EvoKeyShortcutModal from 'dashboard/components/widgets/modal/EvoKeyShortcutModal';
...
export default {
  ...
  watch: {
    displayLayoutType() {
      const { LAYOUT_TYPES } = evoConstants;
  ...
  methods: {
    handleResize() {
      const { SMALL_SCREEN_BREAKPOINT, LAYOUT_TYPES } = evoConstants;
      let throttled = false;
      const delay = 150;
