...
import {
  messageSchema,
  evoMessageWriterSetup,
  EditorView,
  MessageMarkdownTransformer,
  MessageMarkdownSerializer,
  EditorState,
  Selection,
} from '@evochat/prosemirror-schema';
import {
  suggestionsPlugin,
  triggerCharacters,
} from '@evochat/prosemirror-schema/src/mentions/plugin';
...
<style lang="scss">
@import '~@evochat/prosemirror-schema/src/styles/base.scss';
