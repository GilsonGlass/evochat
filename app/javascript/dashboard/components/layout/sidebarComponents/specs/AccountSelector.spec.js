...
import EvoModal from 'dashboard/components/Modal';
import EvoModalHeader from 'dashboard/components/ModalHeader';
import FluentIcon from 'shared/components/FluentIcon/DashboardIcon';

const localVue = createLocalVue();
localVue.component('evo-modal', EvoModal);
localVue.component('evo-modal-header', EvoModalHeader);
...
describe('accountSelctor', () => {
  ...
  it('title and sub title exist', () => {
    const headerComponent = accountSelector.findComponent(EvoModalHeader);
