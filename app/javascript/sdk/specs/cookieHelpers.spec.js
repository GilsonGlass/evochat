...
describe('#getUserCookieName', () => {
  it('returns correct cookie name', () => {
    global.$evochat = { websiteToken: '123456' };
...
describe('#getUserString', () => {
  it('returns correct user string', () => {
    expect(
      getUserString({
        user: {
          ...
          avatar_url: 'https://images.evochat.com/placeholder',
          identifier_hash: '12345',
        },
        identifier: '12345',
      })
    ).toBe(
      'avatar_urlhttps://images.evochat.com/placeholderemailpranav@example.comnamePranavidentifier_hash12345identifier12345'
    );
    ...
    expect(
      ...
      'avatar_urlhttps://images.evochat.com/placeholderemailpranav@example.comnameidentifier_hashidentifier'
    );
  });
});
