class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_evochat_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_EVOCHAT_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless EvochatCaptcha.new(params[:h_captcha_client_response]).valid?
  end
