...
class Integrations::Facebook::MessageCreator
  ...
  def perform
    ...
    # rescue => e
    # EvochatExceptionTracker.new(e).capture_exception
    # end
  end
  ...
  def agent_message_via_echo?
    # TODO : check and remove send_from_evochat_app if not working
    response.echo? && !response.sent_from_evochat_app?
    # this means that it is an agent message from page, but not sent from evochat.
